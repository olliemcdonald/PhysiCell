...
PhysiCell_core_OBJECTS := PhysiCell_phenotype.o PhysiCell_genotype.o PhysiCell_cell_container.o PhysiCell_standard_models.o \
...
test3D:
	cp ./sample_projects/test3D/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/test3D/main-3D.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./sample_projects/test3D/Makefile .
	cp ./sample_projects/test3D/config/* ./config/
# sample projects
...
PhysiCell_genotype.o: ./core/PhysiCell_genotype.cpp
	$(COMPILE_COMMAND) -c ./core/PhysiCell_genotype.cpp
